...
# # 1. 读取两个文件中的数据
# with open('top_passwords_key5_onemar.txt', 'r', encoding='utf-8') as f:
...
#
# # 5. 将存储的数组写入到本地txt文件
# with open('stored_results5_onemar.txt', 'w', encoding='utf-8') as f:
#     for result in stored_results:
#         f.write(f"{result}\n")
#
# with open('guess_number5_onemar.txt', 'w', encoding='utf-8') as f:
...
x_values = read_file_as_list('guess_number.txt')    # 横坐标
